...
// ファイル作成のためのシェルコマンド
const command = `curl --digest -o "${filePath}" -u admin:h809 http://192.168.100.3:63428/snapshot.jpg`;

const command1= ` curl --digest --user admin:h809 "http://192.168.100.3:63428/camera-cgi/admin/param.cgi?action=MusicCtrl&MusicPlay=3"`;
